...
var textModelRouter = map[string]TextModelConfig{
	...
	"gpt-5.1":                {Cost: 3},
	"gpt-5.2":                {Cost: 4},
	"gemini-3-pro":           {Cost: 15},
	"gemini-3.1-pro":         {Cost: 15},
	"gemini-3-flash":         {Cost: 4},
	"gemini-pro":             {Cost: 10},
	"claude-3-opus":          {Cost: 20},
	"o3-pro":                 {Cost: 25},
	"deepseek":               {Cost: 1},
	"deepseek-v3.2":          {Cost: 2},
	"claude-3-sonnet":        {Cost: 4},
	"claude-4.6-sonnet":      {Cost: 4},
	"claude-4.5-opus":        {Cost: 7},
	"claude-4.6-opus":        {Cost: 7},
	"claude-4.5-haiku":       {Cost: 3},
	"gpt-5.1-high":           {Cost: 15},
	"gpt-5.2-high":           {Cost: 22},
	"claude-4.6-sonnet-high": {Cost: 10},
	"claude-3-sonnet-high":   {Cost: 10},
	"grok":                   {Cost: 1},
	"o3":                     {Cost: 3},
	...
	"gpt-5.4-mini":           {Cost: 3},
	"gpt-5.4":                {Cost: 6},
	"gpt-5.4-high":           {Cost: 30},
	"gpt-5.4-pro":            {Cost: 70},
	"o4-mini-deep-research":  {Cost: 50, Internet: true},
	"gpt-4o-search-preview":  {Cost: 15, Internet: true},
	"perplexity-pro":         {Cost: 20, Internet: true},
...
func isSupportedTextModel(model string) bool {
	_, ok := textModelRouter[strings.TrimSpace(model)]
	return ok
}
